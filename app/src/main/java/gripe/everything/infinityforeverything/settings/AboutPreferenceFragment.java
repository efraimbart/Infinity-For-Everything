    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        if (ratePreference != null) {
            ratePreference.setOnPreferenceClickListener(preference -> {
                ...
                playStoreIntent.setData(Uri.parse("market://details?id=gripe.everything.infinityforeverything"));
                if (playStoreIntent.resolveActivity(activity.getPackageManager()) != null) {
                    activity.startActivity(playStoreIntent);
                } else {
                    Intent intent = new Intent(activity, LinkResolverActivity.class);
                    intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=ml.docilealligator.infinityforeverything"));
                    activity.startActivity(intent);
                }
                return true;
            });
