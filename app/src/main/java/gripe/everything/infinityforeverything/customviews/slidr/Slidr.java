package gripe.everything.infinityforeverything.customviews.slidr;
...
import gripe.everything.infinityforeverything.customviews.slidr.model.SlidrInterface;
...
public final class Slidr {
     ...
     * @return a {@link gripe.everything.infinityforeverything.customviews.slidr.model.SlidrInterface} that allows
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@link gripe.everything.infinityforeverything.customviews.slidr.model.SlidrConfig}
     *
     * @param activity the activity to attach the slider to
