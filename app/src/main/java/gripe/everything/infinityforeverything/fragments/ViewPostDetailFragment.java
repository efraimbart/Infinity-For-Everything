...
import static gripe.everything.infinityforeverything.activities.CommentActivity.RETURN_EXTRA_COMMENT_DATA_KEY;
import static gripe.everything.infinityforeverything.activities.CommentActivity.WRITE_COMMENT_REQUEST_CODE;
...
import gripe.everything.infinityforeverything.DeleteThing;
...
import gripe.everything.infinityforeverything.SaveThing;
...
import gripe.everything.infinityforeverything.adapters.CommentsRecyclerViewAdapter;
import gripe.everything.infinityforeverything.adapters.PostDetailRecyclerViewAdapter;
...
import gripe.everything.infinityforeverything.bottomsheetfragments.PostCommentSortTypeBottomSheetFragment;
import gripe.everything.infinityforeverything.comment.Comment;
import gripe.everything.infinityforeverything.comment.FetchComment;
import gripe.everything.infinityforeverything.comment.FetchRemovedComment;
import gripe.everything.infinityforeverything.comment.FetchRemovedCommentReveddit;
import gripe.everything.infinityforeverything.comment.ParseComment;
...
import gripe.everything.infinityforeverything.events.FlairSelectedEvent;
import gripe.everything.infinityforeverything.events.PostUpdateEventToPostDetailFragment;
import gripe.everything.infinityforeverything.events.PostUpdateEventToPostList;
import gripe.everything.infinityforeverything.message.ReadMessage;
import gripe.everything.infinityforeverything.post.FetchPost;
import gripe.everything.infinityforeverything.post.FetchRemovedPost;
import gripe.everything.infinityforeverything.post.HidePost;
import gripe.everything.infinityforeverything.post.ParsePost;
import gripe.everything.infinityforeverything.post.Post;
import gripe.everything.infinityforeverything.readpost.InsertReadPost;
import gripe.everything.infinityforeverything.subreddit.FetchSubredditData;
...
public class ViewPostDetailFragment extends Fragment implements FragmentCommunicator {
    ...
    private void fetchComments(boolean changeRefreshState, SortType.Type sortType) {
        ...
        FetchComment.fetchComments(mExecutor, new Handler(), retrofit, mAccessToken, mPost.getId(), mPost.getSubredditName(), commentId, sortType,
    ...
    public void refresh(boolean fetchPost, boolean fetchComments) {
        if (mPostAdapter != null && !isRefreshing) {
            ...
            if (fetchPost) {
                ...
                FetchPost.fetchPost(mExecutor, new Handler(), retrofit, mPost.getId(), mPost.getSubredditName(), mAccessToken,
