...
import gripe.everything.infinityforeverything.AnyAccountAccessTokenAuthenticator;
...
import gripe.everything.infinityforeverything.UploadImageEnabledActivity;
import gripe.everything.infinityforeverything.UploadedImage;
import gripe.everything.infinityforeverything.account.Account;
import gripe.everything.infinityforeverything.adapters.MarkdownBottomBarRecyclerViewAdapter;
...
import gripe.everything.infinityforeverything.bottomsheetfragments.UploadedImagesBottomSheetFragment;
import gripe.everything.infinityforeverything.comment.Comment;
import gripe.everything.infinityforeverything.comment.SendComment;
...
import gripe.everything.infinityforeverything.databinding.ActivityCommentBinding;
...
public class CommentActivity extends BaseActivity implements UploadImageEnabledActivity, AccountChooserBottomSheetFragment.AccountChooserListener {
    ...
    public void captureImage() {
        ...
        try {
            capturedImageUri = FileProvider.getUriForFile(this, "gripe.everything.infinityforeverything.provider",
