...
import gripe.everything.infinityforeverything.RedditGalleryPayload;
import gripe.everything.infinityforeverything.account.Account;
import gripe.everything.infinityforeverything.adapters.RedditGallerySubmissionRecyclerViewAdapter;
...
import gripe.everything.infinityforeverything.bottomsheetfragments.SelectOrCaptureImageBottomSheetFragment;
...
import gripe.everything.infinityforeverything.utils.UploadImageUtils;
...
public class PostGalleryActivity extends BaseActivity implements FlairBottomSheetFragment.FlairSelectionCallback,
    ...
    public void captureImage() {
        ...
        try {
            imageUri = FileProvider.getUriForFile(this, "gripe.everything.infinityforeverything.provider",
